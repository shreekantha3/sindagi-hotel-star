# Hotel Star — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-hotel-star/
- **Repo:** `shreekantha3/sindagi-hotel-star` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-hotel-star/'` for GitHub Pages project-site hosting.
